...
def test_first_paint_has_a_static_shell_and_non_parser_blocking_app_files():
    ...
    assert '<link rel="preload" href="/release-assets/r74/app-v15.min.js" as="script" />' in INDEX
    assert '<script defer src="/release-assets/r74/crew-planner-v15.min.js"></script>' in INDEX
    assert '<script defer src="/release-assets/r74/app-v15.min.js"></script>' in INDEX
