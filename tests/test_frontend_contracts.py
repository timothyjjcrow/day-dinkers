...
def test_offline_shell_and_signed_in_snapshot_contracts():
    ...
    for asset in (
        "/release-assets/r78/styles-v15.min.css",
        "/release-assets/r78/crew-planner-v15.min.js",
        "/release-assets/r78/tournament-bracket-v15.min.js",
        "/release-assets/r78/venue-workspace-v15.min.js",
        "/release-assets/r78/app-v15.min.js",
    ):
        assert asset in SERVICE_WORKER
    assert 'href="/release-assets/r78/styles-v15.min.css"' in INDEX
    assert 'src="/release-assets/r78/crew-planner-v15.min.js"' in INDEX
    assert 'src="/release-assets/r78/app-v15.min.js"' in INDEX
