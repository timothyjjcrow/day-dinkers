...
def test_offline_shell_and_signed_in_snapshot_contracts():
    ...
    for asset in (
        "/release-assets/r80/styles-v15.min.css",
        "/release-assets/r80/crew-planner-v15.min.js",
        "/release-assets/r80/tournament-bracket-v15.min.js",
        "/release-assets/r80/venue-workspace-v15.min.js",
        "/release-assets/r80/app-v15.min.js",
    ):
        assert asset in SERVICE_WORKER
    assert 'href="/release-assets/r80/styles-v15.min.css"' in INDEX
    assert 'src="/release-assets/r80/crew-planner-v15.min.js"' in INDEX
    assert 'src="/release-assets/r80/app-v15.min.js"' in INDEX
