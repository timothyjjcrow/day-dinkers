...
def test_offline_shell_and_signed_in_snapshot_contracts():
    ...
    assert 'href="/release-assets/r73/styles-v15.min.css"' in INDEX
    assert 'src="/release-assets/r73/crew-planner-v15.min.js"' in INDEX
    assert 'src="/release-assets/r73/app-v15.min.js"' in INDEX
